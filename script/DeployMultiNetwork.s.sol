 ...
 *
 *   # Deploy to mainnet
 *   forge script script/DeployMultiNetwork.s.sol --rpc-url https://api.lux.network/ext/bc/C/rpc --broadcast -vvv
 *
 *   # Deploy to testnet
 *   forge script script/DeployMultiNetwork.s.sol --rpc-url https://api.lux-test.network/ext/bc/C/rpc --broadcast -vvv
 *
 *   # Deploy to devnet
 *   forge script script/DeployMultiNetwork.s.sol --rpc-url https://api.lux-dev.network/ext/bc/C/rpc --broadcast -vvv
 */
contract DeployMultiNetwork is Script {
    ...
    function run() external {
        ...
        require(deployer.balance >= 1 ether, "Insufficient balance");
        ...
        // Phase 2: Staking & Liquid
        _deployPhase2StakingLiquid();
    ...
    function _deployPhase2StakingLiquid() internal {
        console.log("--- Phase 2: Staking & Liquid ---");
