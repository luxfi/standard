...
contract TypedSealedOutputsTest is PermissionedV2 {
    ...
    function getSealedEBool(PermissionV2 memory permission, bool value)
        public
    ...
    function getSealedEUint8(PermissionV2 memory permission, uint8 value)
        public
        withPermission(permission)
        returns (bytes memory)
    {
    ...
    function getSealedEUint16(PermissionV2 memory permission, uint16 value)
        public
        withPermission(permission)
        returns (bytes memory)
    {
    ...
    function getSealedEUint32(PermissionV2 memory permission, uint32 value)
        public
        withPermission(permission)
        returns (bytes memory)
    {
    ...
    function getSealedEUint64(PermissionV2 memory permission, uint64 value)
        public
        withPermission(permission)
        returns (bytes memory)
    {
    ...
    function getSealedEUint128(PermissionV2 memory permission, uint128 value)
        public
        withPermission(permission)
        returns (bytes memory)
    {
    ...
    function getSealedEUint256(PermissionV2 memory permission, uint256 value)
        public
        withPermission(permission)
        returns (bytes memory)
    {
    ...
    function getSealedEAddress(PermissionV2 memory permission, address value)
        public
        withPermission(permission)
        returns (bytes memory)
    {
