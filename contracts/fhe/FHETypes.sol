...
// FHE precompiles are in the Lux Privacy range: 0x0700...0080-0083
// These are EVM precompiles, NOT deployed contracts

/// @dev Main FHE operations precompile (arithmetic, comparison, etc.)
address constant FHE_PRECOMPILE = 0x0700000000000000000000000000000000000080;

/// @dev Access Control List precompile (allow/deny ciphertext access)
address constant FHE_ACL_PRECOMPILE = 0x0700000000000000000000000000000000000081;

/// @dev Input Verifier precompile (verify encrypted inputs)
address constant FHE_INPUT_PRECOMPILE = 0x0700000000000000000000000000000000000082;

/// @dev Gateway precompile (decryption requests to T-Chain)
address constant FHE_GATEWAY_PRECOMPILE = 0x0700000000000000000000000000000000000083;
