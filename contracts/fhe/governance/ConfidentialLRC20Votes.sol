...
import { ConfidentialLRC20 } from "../token/LRC20/ConfidentialLRC20.sol";
import { IConfidentialLRC20Votes } from "./IConfidentialLRC20Votes.sol";

/**
 * @title   ConfidentialLRC20Votes.
 * @notice  This contract inherits ConfidentialLRC20, EIP712, and Ownable2Step.
 ...
 */
abstract contract ConfidentialLRC20Votes is IConfidentialLRC20Votes, ConfidentialLRC20, EIP712, Ownable2Step {
    ...
    /**
     * @notice See {IConfidentialLRC20Votes-getPriorVotesForGovernor}.
     */
