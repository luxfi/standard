...
library Console {
    function _logImpl(string memory payload) internal pure {
        IFheOps(Precompiles.Fheos).log(payload);
    }
    ...
    function _logImpl3Params(string memory p0, string memory p1, string memory p2) internal pure {
        string memory payload = string(abi.encodePacked(string("p0: "), p0, string(" p1: "), p1, string(" p2: "), p2));
        _logImpl(payload);
    }

    function _intToString(int256 _value) internal pure returns (string memory) {
