...
/**
 * @title   ConfidentialLRC20.
 * @notice  This contract implements an encrypted LRC20-like token with confidential balances using
 *          LuxFHE's Fully Homomorphic Encryption library.
 * @dev     It supports standard LRC20 functions such as transferring tokens, minting,
 *          and setting allowances, but uses encrypted data types.
 *          The total supply is not encrypted.
 */
abstract contract ConfidentialLRC20 is IConfidentialLRC20, IERC20Errors, TFHEErrors {
    ...
    /**
     * @notice See {IConfidentialLRC20-approve}.
     */
    ...
    /**
     * @notice See {IConfidentialLRC20-allowance}.
     */
    ...
    /**
     * @notice See {IConfidentialLRC20-balanceOf}.
     */
    ...
    /**
     * @notice See {IConfidentialLRC20-decimals}.
     */
    ...
    /**
     * @notice See {IConfidentialLRC20-name}.
     */
    ...
    /**
     * @notice See {IConfidentialLRC20-symbol}.
     */
    ...
    /**
     * @notice See {IConfidentialLRC20-totalSupply}.
     */
