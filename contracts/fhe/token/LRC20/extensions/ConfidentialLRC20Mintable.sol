...
/**
 * @title   ConfidentialLRC20Mintable.
 * @notice  This contract inherits ConfidentialLRC20.
 * @dev     It allows an owner to mint tokens. Mint amounts are not encrypted.
 */
abstract contract ConfidentialLRC20Mintable is Ownable2Step, ConfidentialLRC20 {
    /**
    ...
    constructor(
        ...
        address owner_
    ) Ownable(owner_) ConfidentialLRC20(name_, symbol_) {}
