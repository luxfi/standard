    ...
    TFHEApp
{
    ...
    /**
     * @notice                          Deposit/withdraw LUX (or other native tokens).
    ...
    /**
     * @notice         Unwrap ConfidentialLRC20 tokens to LUX (or other native tokens).
    ...
    /**
     * @notice Wrap LUX (or other native token) to an encrypted format.
     */
