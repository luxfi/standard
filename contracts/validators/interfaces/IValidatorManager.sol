 ...
 * @notice The chainID is the ID of the chain that the Validator Manager is managing
 ...
 * a chain to an L1 on the P-Chain.
...
/**
 * @notice Interface for Validator Manager contracts that implement Chain-only Validator management.
 */
interface IValidatorManager {
    ...
    /**
     * @notice Verifies and sets the initial validator set for the chain through a P-Chain ChainToL1ConversionMessage.
     * @param conversionData The chain conversion message data used to recompute and verify against the conversionID.
     * @param messsageIndex The index that contains the ChainToL1ConversionMessage Warp message containing the conversionID to be verified against the provided {ConversionData}
     */
