...
contract Vault is ReentrancyGuard, IVault {
    ...
    function getRedemptionAmount(address _token, uint256 _lpusdAmount) public view override returns (uint256) {
    ...
    function getTargetLpusdAmount(address _token) public view override returns (uint256) {
