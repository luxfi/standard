 ...
 * - LETH: Liquid debt token (minted by this vault)
 *
 * Flow:
 ...
 * - Debt: LETH (liquid debt token, minted by vault)
...
contract LiquidETH is Ownable, AccessControl, ReentrancyGuard {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // BORROW / REPAY (LETH Debt Token)
    // ═══════════════════════════════════════════════════════════════════════

    /**
     * @notice Borrow LETH against ETH collateral
     * @param amount Amount of LETH to borrow (debt token minted to user)
     */
