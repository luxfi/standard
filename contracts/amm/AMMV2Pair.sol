...
contract AMMV2Pair is ERC20, ReentrancyGuard {
    ...
    constructor() ERC20("AMM V2 LP", "AMMV2-LP") {
        factory = msg.sender;
    }

    function initialize(address _token0, address _token1) external {
        require(msg.sender == factory, "AMMV2: FORBIDDEN");
        token0 = _token0;
        token1 = _token1;
    }
    ...
    function mint(address to) external nonReentrant returns (uint256 liquidity) {
        ...
        if (_totalSupply == 0) {
            ...
            _mint(address(0xdead), MINIMUM_LIQUIDITY); // Permanently lock first MINIMUM_LIQUIDITY tokens
        } else {
