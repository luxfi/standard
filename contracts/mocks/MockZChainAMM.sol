...
contract MockZChainAMM is IZChainAMM {
        ...
        returns (bytes32 outputCommitment)
    {
        ...
        outputCommitment = keccak256(abi.encodePacked(recipient, encryptedAmount, block.timestamp));
    ...
    function verifySwapProof(bytes calldata proof, bytes32 commitment, bytes32 poolId)
        external
        view
        override
        returns (bool)
