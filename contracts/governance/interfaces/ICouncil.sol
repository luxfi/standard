 ...
 * governance with support for various voting charters and token standards.
 *
 * Key features:
 * - Proposal submission with customizable proposer adapters
 * - Flexible voting through a delegated charter contract
 * - Timelock mechanism for security
 * - Execution period constraints
 * - Safe integration for transaction execution
 *
 * The module delegates voting logic to a Charter contract, allowing DAOs to
 ...
 * - Requires a valid Charter contract for voting
...
interface ICouncil {
     ...
     * @param charter The voting charter for this proposal
    ...
    /**
     * @notice Emitted when charter is updated
     * @param charter New charter address
     */
    event CharterUpdated(address charter);
     ...
     * @param charter_ The initial voting charter
    ...
    /**
     * @notice Returns the default charter
     ...
     * @param proposalId_ The proposal ID
     * @return charter The voting charter
    ...
    /**
     * @notice Updates the default charter
     * @param charter_ New charter address
     */
    function updateCharter(address charter_) external;
