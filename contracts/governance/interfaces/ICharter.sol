 ...
 * @notice Core voting charter contract for the Lux governance system
 ...
 * - Veto voter authorization for emergency governance
 *
 * Voting mechanics:
...
interface ICharter {
    ...
    /**
     * @notice Initialize charter with core voting parameters (step 1)
    ...
    function addAuthorizedVetoVoter(address vetoVoterContract_) external;

    function removeAuthorizedVetoVoter(address vetoVoterContract_) external;
}
