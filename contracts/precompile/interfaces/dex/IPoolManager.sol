...
interface ILockCallback {
    /// @notice Called by the PoolManager during lock()
    /// @param data The data passed to lock()
    /// @return result Data to return from lock()
...
interface IFlashCallback {
    /// @notice Called by the PoolManager during flash()
    /// @param currency The borrowed currency
