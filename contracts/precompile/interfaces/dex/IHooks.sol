...
interface IHooks {
    ...
    function beforeInitialize(PoolKey calldata key, uint160 sqrtPriceX96, bytes calldata hookData) external;
    ...
    /// @param hookData Additional data from the caller
    function afterInitialize(PoolKey calldata key, uint160 sqrtPriceX96, int24 tick, bytes calldata hookData) external;

    /// @notice Called before liquidity is added
    /// @param key The pool key
    /// @param params The modify liquidity parameters
    /// @param hookData Additional data from the caller
    function beforeAddLiquidity(PoolKey calldata key, ModifyLiquidityParams calldata params, bytes calldata hookData)
        external;
    ...
    /// @param params The modify liquidity parameters
    /// @param hookData Additional data from the caller
    function beforeRemoveLiquidity(PoolKey calldata key, ModifyLiquidityParams calldata params, bytes calldata hookData)
        external;
    ...
    function beforeSwap(PoolKey calldata key, SwapParams calldata params, bytes calldata hookData)
        external
    ...
    /// @param hookData Additional data from the caller
    function afterSwap(PoolKey calldata key, SwapParams calldata params, BalanceDelta delta, bytes calldata hookData)
        external;
    ...
    /// @param hookData Additional data from the caller
    function beforeDonate(PoolKey calldata key, uint256 amount0, uint256 amount1, bytes calldata hookData) external;
    ...
    /// @param amount1 The amount of currency1
    /// @param hookData Additional data from the caller
    function afterDonate(PoolKey calldata key, uint256 amount0, uint256 amount1, bytes calldata hookData) external;
    ...
    function beforeFlash(PoolKey calldata key, address borrower, uint256 amount, uint256 fee, bytes calldata data)
        external;
    ...
    /// @param fee The flash loan fee
    /// @param data Additional data from the caller
    function afterFlash(PoolKey calldata key, address borrower, uint256 amount, uint256 fee, bytes calldata data)
        external;
}
...
abstract contract BaseHook is IHooks {
    ...
    function getHookPermissions() public pure virtual returns (HookPermissions);

    // Default implementations - override as needed

    function beforeInitialize(PoolKey calldata, uint160, bytes calldata) external pure virtual { }
    function afterInitialize(PoolKey calldata, uint160, int24, bytes calldata) external pure virtual { }
    function beforeAddLiquidity(PoolKey calldata, ModifyLiquidityParams calldata, bytes calldata)
        external
        pure
        virtual { }
    function afterAddLiquidity(
    ...
    function beforeRemoveLiquidity(PoolKey calldata, ModifyLiquidityParams calldata, bytes calldata)
        external
        pure
        virtual { }
    function afterRemoveLiquidity(
    ...
    function beforeSwap(PoolKey calldata, SwapParams calldata, bytes calldata) external pure virtual returns (uint24) {
        return 0;
    }
    function afterSwap(PoolKey calldata, SwapParams calldata, BalanceDelta, bytes calldata) external pure virtual { }
    function beforeDonate(PoolKey calldata, uint256, uint256, bytes calldata) external pure virtual { }
    function afterDonate(PoolKey calldata, uint256, uint256, bytes calldata) external pure virtual { }
    function beforeFlash(PoolKey calldata, address, uint256, uint256, bytes calldata) external pure virtual { }
    function afterFlash(PoolKey calldata, address, uint256, uint256, bytes calldata) external pure virtual { }
}
...
interface IHookRegistry {
    ...
    function getHookPermissions(address hook) external view returns (HookPermissions);
}
