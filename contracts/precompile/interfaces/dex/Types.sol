...
// =========================================================================
// Currency - Represents a token (native or LRC20)
// =========================================================================

/// @notice Represents a currency (native LUX or LRC20 token)
...
library BalanceDeltaLib {
    ...
    function create(int256 _amount0, int256 _amount1) internal pure returns (BalanceDelta) {
        return BalanceDelta.wrap(_amount0 - _amount1);
    }
}
