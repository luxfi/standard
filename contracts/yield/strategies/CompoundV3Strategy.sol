...
contract CompoundV3Strategy is Ownable, ReentrancyGuard {
    ...
    constructor(string memory _name, address _comet, address _owner) Ownable(_owner) {
        name = _name;
        comet = IComet(_comet);
    ...
    function getMarketInfo()
        external
        view
        returns (uint256 totalSupply, uint256 totalBorrow, uint256 utilization, uint256 supplyRate)
    {
...
contract CompoundV3USDCStrategy is CompoundV3Strategy {
    ...
    constructor(address _owner) CompoundV3Strategy("Compound V3 USDC", CUSDC_V3, _owner) { }
}
...
contract CompoundV3WETHStrategy is CompoundV3Strategy {
    ...
    constructor(address _owner) CompoundV3Strategy("Compound V3 WETH", CWETH_V3, _owner) { }
}
...
contract CompoundV3USDCBaseStrategy is CompoundV3Strategy {
    ...
    constructor(address _owner) CompoundV3Strategy("Compound V3 USDC (Base)", CUSDC_V3_BASE, _owner) { }
}
...
contract CompoundV3USDbCBaseStrategy is CompoundV3Strategy {
    ...
    constructor(address _owner) CompoundV3Strategy("Compound V3 USDbC (Base)", CUSDBC_V3_BASE, _owner) { }
}
