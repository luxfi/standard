...
library DistributionLib {
    ...
    function calculateShare(uint256 total, uint256 shareBps) internal pure returns (uint256) {
    ...
    function isStreaming(DistributionType dtype) internal pure returns (bool) {
        return dtype == DistributionType.STREAMING || dtype == DistributionType.VESTING;
    }
}
