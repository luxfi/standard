...
interface IRangeProofVerifier {
    ...
    function verifyAggregate(AggregateProof calldata aggProof, uint8 bitLength) external view returns (bool);
    ...
    function computeCommitment(uint256 value, uint256 blinding) external view returns (bytes32);
}
