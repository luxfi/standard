    ...
    ERC165
{
     ...
     */
    function initialize(address owner_, address avatar_, address target_) public virtual override initializer {
    ...
    function setUp(bytes memory initializeParams_) public virtual override initializer {
        (address owner_, address avatar_, address target_) = abi.decode(initializeParams_, (address, address, address));
     ...
     */
    function execTx(Transaction calldata transaction_) public virtual override onlyOwner {
    ...
    function supportsInterface(bytes4 interfaceId_) public view virtual override returns (bool) {
        return interfaceId_ == type(IModuleFractalV1).interfaceId || interfaceId_ == type(IVersion).interfaceId
