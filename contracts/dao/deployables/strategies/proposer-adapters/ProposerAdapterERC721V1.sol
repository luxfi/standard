    ...
    ERC165
{
     ...
     */
    function _getProposerAdapterERC721Storage() internal pure returns (ProposerAdapterERC721Storage storage $) {
    ...
    function initialize(address token_, uint256 proposerThreshold_) public virtual override initializer {
        ...
        ProposerAdapterERC721Storage storage $ = _getProposerAdapterERC721Storage();
    ...
    function supportsInterface(bytes4 interfaceId_) public view virtual override returns (bool) {
        return interfaceId_ == type(IProposerAdapterERC721V1).interfaceId
