 ...
 */
contract KeyValuePairsV1 is IKeyValuePairsV1, IVersion, DeploymentBlockNonInitializable, ERC165 {
    // ======================================================================
    // IKeyValuePairs
    // ======================================================================
     ...
     */
    function updateValues(KeyValuePair[] calldata keyValuePairs_) public virtual override {
    ...
    function supportsInterface(bytes4 interfaceId_) public view virtual override returns (bool) {
        return interfaceId_ == type(IKeyValuePairsV1).interfaceId || interfaceId_ == type(IVersion).interfaceId
