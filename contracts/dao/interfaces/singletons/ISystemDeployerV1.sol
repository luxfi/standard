 ...
 * - Handles circular dependency resolution (Governor ↔ Strategy ↔ VotingConfigs)
 ...
 * 5. Deploys Governor module as the main governance system
 * 6. Completes strategy initialization with Governor and voting adapters
...
interface ISystemDeployerV1 {
     ...
     * @param implementation The ModuleGovernorV1 implementation
    ...
    /**
     * @notice Complete configuration for Governor-based governance
     */
    struct GovernorGovernanceParams {
        ProposerAdapterParams proposerAdapterParams;
        StrategyV1Params strategyV1Params;
        VotingConfigParams votingConfigParams;
        ModuleGovernorV1Params moduleGovernorV1Params;
    }
    ...
    /**
     * @notice Parameters for Governor freeze guard
     * @param implementation The FreezeGuardGovernorV1 implementation
     * @param owner The freeze voting contract that controls freezing
     */
    struct FreezeGuardGovernorV1Params {
        address implementation;
        address owner;
    }
    ...
    /**
     * @notice Parameters for Governor-based freeze voting
     * @param implementation The FreezeVotingGovernorV1 implementation
     * @param owner The parent DAO that can update settings
     * @param freezeVotesThreshold Votes required to freeze
     * @param freezeProposalPeriod Duration for freeze voting
     * @param parentGovernor The parent DAO's Governor module
     * @param lightAccountFactory Address of the LightAccountFactory
     */
    struct FreezeVotingGovernorV1Params {
        address implementation;
        address owner;
        uint256 freezeVotesThreshold;
        uint32 freezeProposalPeriod;
    ...
    struct FreezeGuardParams {
        ...
        FreezeGuardGovernorV1Params freezeGuardGovernorV1Params;
    }
    ...
    struct FreezeVotingParams {
        ...
        FreezeVotingGovernorV1Params freezeVotingGovernorV1Params;
     ...
     * @param governorGovernanceParams_ Complete Governor governance setup
