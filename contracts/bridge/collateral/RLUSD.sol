 ...
 * @notice 1:1 bridged Ripple USD collateral on Lux (minted by BridgeV4)
 * @dev USD basket member — accepted as deposit into LiquidUSD pool
 */
contract BridgedRLUSD is LRC20B {
    string public constant _name = "Bridged RLUSD";
    string public constant _symbol = "RLUSD";
