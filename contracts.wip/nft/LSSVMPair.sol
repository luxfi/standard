...
abstract contract LSSVMPair is OwnableWithTransferCallback, ERC721Holder, ERC1155Holder {
     ...
     * @notice The revert handling is forked from: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/c239e1af8d1a1296577108dd6989a17b57434f8e/standard/utils/Address.sol#L201
    ...
    function multicall(bytes[] calldata calls, bool revertOnFail) external onlyOwner {
        for (uint256 i; i < calls.length;) {
            ...
            // transferOwnership(address,bytes) = 0x0d88b11c  
            if (sig == bytes4(0xf2fde38b) || sig == bytes4(0x0d88b11c)) revert LSSVMPair__FunctionNotAllowed();
