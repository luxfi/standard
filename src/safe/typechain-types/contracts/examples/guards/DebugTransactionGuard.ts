...
export interface DebugTransactionGuard extends BaseContract {
  ...
  >;
  getEvent(
    key: "ModuleTransactionDetails"
  ): TypedContractEvent<
    ModuleTransactionDetailsEvent.InputTuple,
    ModuleTransactionDetailsEvent.OutputTuple,
    ModuleTransactionDetailsEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "ModuleTransactionDetails(bytes32,address,uint256,bytes,uint8,address)": TypedContractEvent<
      ModuleTransactionDetailsEvent.InputTuple,
      ModuleTransactionDetailsEvent.OutputTuple,
      ModuleTransactionDetailsEvent.OutputObject
    >;
    ModuleTransactionDetails: TypedContractEvent<
      ModuleTransactionDetailsEvent.InputTuple,
      ModuleTransactionDetailsEvent.OutputTuple,
      ModuleTransactionDetailsEvent.OutputObject
    >;
