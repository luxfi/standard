...
export interface ISafeInterface extends Interface {
    ...
    getEvent(nameOrSignatureOrTopic: "AddedOwner" | "ApproveHash" | "ChangedFallbackHandler" | "ChangedGuard" | "ChangedModuleGuard" | "ChangedThreshold" | "DisabledModule" | "EnabledModule" | "ExecutionFailure" | "ExecutionFromModuleFailure" | "ExecutionFromModuleSuccess" | "ExecutionSuccess" | "RemovedOwner" | "SafeSetup" | "SignMsg"): EventFragment;
...
export declare namespace ChangedModuleGuardEvent {
    type InputTuple = [moduleGuard: AddressLike];
    type OutputTuple = [moduleGuard: string];
    interface OutputObject {
        moduleGuard: string;
    }
    type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export interface ISafe extends BaseContract {
    ...
    getFunction(nameOrSignature: "signedMessages"): TypedContractMethod<[messageHash: BytesLike], [bigint], "view">;
