...
export interface SafeL2Interface extends Interface {
    ...
    encodeFunctionData(functionFragment: "checkSignatures(bytes32,bytes)", values: [BytesLike, BytesLike]): string;
    ...
    decodeFunctionResult(functionFragment: "checkSignatures(bytes32,bytes)", data: BytesLike): Result;
...
export declare namespace SafeModuleTransactionEvent {
    type InputTuple = [
        module: AddressLike,
        to: AddressLike,
        value: BigNumberish,
...
export interface SafeL2 extends BaseContract {
    ...
    getFunction(nameOrSignature: "checkSignatures(bytes32,bytes)"): TypedContractMethod<[
        dataHash: BytesLike,
        signatures: BytesLike
    ], [
        void
