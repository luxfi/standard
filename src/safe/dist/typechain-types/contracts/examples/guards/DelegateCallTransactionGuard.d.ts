...
export interface DelegateCallTransactionGuard extends BaseContract {
    ...
    ALLOWED_TARGET: TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "ALLOWED_TARGET"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "checkAfterExecution"): TypedContractMethod<[arg0: BytesLike, arg1: boolean], [void], "view">;
    getFunction(nameOrSignature: "checkAfterModuleExecution"): TypedContractMethod<[arg0: BytesLike, arg1: boolean], [void], "view">;
