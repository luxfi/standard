...
\begin{enumerate}
    ...
    \item Mint synthetic assets (xUSD, xETH, xBTC, xLUX)
...
\begin{itemize}
    \item \textbf{xUSD}: Synthetic USD, pegged to \$1
    \item \textbf{xETH}: Synthetic Ethereum
    \item \textbf{xBTC}: Synthetic Bitcoin
    \item \textbf{xLUX}: Synthetic LUX (leveraged exposure)
    \item \textbf{xSOL}: Synthetic Solana
    \item \textbf{xTON}: Synthetic Toncoin
    \item \textbf{xADA}: Synthetic Cardano
    \item \textbf{xAVAX}: Synthetic Avalanche
    \item \textbf{xBNB}: Synthetic Binance Coin
    \item \textbf{xPOL}: Synthetic Polygon
    \item \textbf{xZOO}: Synthetic Zoo Token
    \item \textbf{xAI}: Synthetic AI Token
\end{itemize}
