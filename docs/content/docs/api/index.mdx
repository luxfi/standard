...
| [LUXD](/docs/tokens/luxd) | Dollar stablecoin | `@luxfi/contracts/tokens/LUX.sol` |
...
| Contract | Description | Import |
|----------|-------------|--------|
| [LiquidLUX | Unified yield vault | `@luxfi/contracts/liquid/LiquidLUX.sol`` |
| [LiquidToken | Flash loan base token | `@luxfi/contracts/liquid/LiquidToken.sol`` |
...
Unified yield vault interface (Liquid protocol).
