...
import "@luxfi/contracts/tokens/LUX.sol";          // Lux Dollar stablecoin
...
// DeFi
import "@luxfi/contracts/liquid/LiquidLUX.sol";   // Unified yield vault
import "@luxfi/contracts/liquid/LiquidToken.sol";  // Flash loan tokens
...
<Cards>
  ...
  <Card title="DeFi" href="/docs/defi">
    Build with liquid tokens, perpetuals, and lending
  </Card>
